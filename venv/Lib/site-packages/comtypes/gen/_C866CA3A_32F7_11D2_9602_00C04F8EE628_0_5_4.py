...
__all__ = [
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRs_NewEnum',
    'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_PRIVATE7',
    'SVSFlagsAsync', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRGCmdLoadFromFile',
    'SPEI_VISEME', 'SpeechGrammarTagDictation',
    'SAFTCCITT_ALaw_11kHzStereo', 'SLTApp',
    'DISPID_SRCVoicePurgeEvent', '_ISpeechRecoContextEvents',
    'DISPID_SRCEPhraseStart', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRGDictationLoad', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRCRecognizer', 'ISpeechGrammarRule',
    'SPINTERFERENCE_TOOFAST', 'SpeechBookmarkOptions',
    'DISPIDSPTSI_ActiveOffset', 'SVSFParseSapi',
    'DISPID_SDKDeleteKey', 'SPBO_NONE', 'SPSEMANTICERRORINFO',
    'ISpeechTextSelectionInformation', 'DISPID_SVSVisemeId',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_UNDEFINED', 'SP_VISEME_10',
    'ISpeechPhoneConverter', 'DISPID_SGRSTransitions', 'SPWT_DISPLAY',
    'DISPID_SVEWord', 'SVP_2', 'SAFT22kHz16BitStereo',
    'SPEI_END_SR_STREAM', 'SAFTCCITT_uLaw_44kHzStereo', 'SINoSignal',
    'SpeechPropertyAdaptationOn', 'SPWORD', 'SpeechRegistryUserRoot',
    'SPINTERFERENCE_TOOLOUD', 'SpeechTokenKeyUI',
    'SPEI_SR_AUDIO_LEVEL', 'SPSHT_NotOverriden', 'SVEAllEvents',
    'ISpEventSource', 'SPEVENT', 'SPGS_EXCLUSIVE', 'ISpPhraseAlt',
    'ISpProperties', 'DISPID_SRCCreateGrammar',
    'DISPID_SOTGetDescription', 'eLEXTYPE_PRIVATE15',
    'SpeechTokenContext', 'SVP_21', 'eLEXTYPE_USER',
    'SPDATAKEYLOCATION', 'DISPID_SRCEBookmark',
    'SpeechRuleAttributes', 'SP_VISEME_9', 'eLEXTYPE_RESERVED7',
    'eWORDTYPE_ADDED', 'SPRULESTATE', 'SpeechRecoProfileProperties',
    'SPSInterjection', 'DISPID_SRSetPropertyString',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPBO_TIME_UNITS', 'SSSPTRelativeToCurrentPosition',
    'SP_VISEME_3', 'DISPID_SVSLastBookmarkId',
    'SpeechAudioFormatGUIDWave', 'IEnumSpObjectTokens',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPRuleChildren', 'DISPID_SVEViseme',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechCustomStream',
    'SPXRO_Alternates_SML', 'DISPID_SpeechRecoContextEvents',
    'SWPUnknownWordUnpronounceable', 'SSSPTRelativeToEnd',
    'DISPID_SpeechPhraseProperty', 'SPPHRASEPROPERTY', 'SREPrivate',
    'DISPID_SLPSymbolic', 'SECFIgnoreKanaType', 'SREPhraseStart',
    'SPAO_NONE', 'SPLOADOPTIONS', 'SASStop', 'DISPID_SPAsItem',
    'WAVEFORMATEX', 'DISPID_SPERetainedStreamOffset', 'SRTStandard',
    'ISpeechAudioBufferInfo', 'SPPS_SuppressWord', 'DISPID_SRGState',
    'ISpeechGrammarRuleState', 'DISPID_SRGDictationUnload',
    'ISpeechRecoGrammar', 'SAFTGSM610_8kHzMono',
    'DISPID_SPRuleFirstElement', 'SRTExtendableParse',
    'DISPID_SPEs_NewEnum', 'SAFT48kHz8BitMono', 'ISpObjectToken',
    'DISPID_SpeechWaveFormatEx', 'eLEXTYPE_PRIVATE8',
    '__MIDL_IWinTypes_0009', 'DISPID_SGRSTPropertyValue',
    'SRTAutopause', 'SPWF_SRENGINE', 'DISPID_SRCEStartStream',
    'ISpRecoContext', 'SPEI_RESERVED3', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPRFirstElement', 'DISPID_SLWsItem', 'SPWT_PRONUNCIATION',
    'SPSHORTCUTTYPE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SGRInitialState', 'SAFTADPCM_44kHzMono', 'SVP_14',
    'SAFT12kHz16BitStereo', 'SAFTGSM610_44kHzMono',
    'DISPID_SADefaultFormat', 'SVP_7', 'SPVPRIORITY',
    'DISPID_SBSFormat', 'SPCT_SUB_COMMAND', 'SPRECOSTATE', 'SDTAudio',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFT32kHz16BitStereo', 'SPSLMA', 'SVP_13',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVAudioOutput',
    'SVP_17', 'SDTDisplayText', 'ISpObjectTokenCategory', 'SLTUser',
    'SpeechCategoryRecoProfiles', 'Speech_Max_Pron_Length',
    'SAFT48kHz8BitStereo', 'STCLocalServer',
    'DISPID_SGRSTPropertyName', 'ISpeechResourceLoader', 'SITooQuiet',
    'DISPID_SGRSTWeight', 'SRATopLevel', 'SVSFParseMask',
    'ISpeechMemoryStream', 'DISPID_SPIGetDisplayAttributes',
    'ISpNotifyTranslator', 'DISPID_SRRGetXMLResult',
    'DISPID_SRRTTickCount', 'ISpeechPhraseProperties',
    'SPEI_INTERFERENCE', 'DISPID_SDKGetlongValue', 'SPAS_RUN',
    'SVSFPersistXML', 'SpeechGrammarTagUnlimitedDictation',
    'SPAS_PAUSE', 'SPVOICESTATUS', 'DISPID_SDKCreateKey',
    'SPPROPERTYINFO', 'DISPID_SGRAttributes', 'ISpeechRecoResult',
    'DISPID_SVDisplayUI', 'SP_VISEME_20', 'SPPS_Interjection',
    'DISPID_SpeechBaseStream', 'DISPID_SDKOpenKey',
    'DISPID_SVEBookmark', 'DISPID_SRCERequestUI',
    'SPWORDPRONUNCIATION', 'DISPID_SVSkip',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechLexiconProns',
    'DISPIDSPTSI', 'DISPID_SPPId', 'DISPID_SDKEnumValues',
    'SGRSTTWord', 'SAFT12kHz8BitStereo',
    'DISPID_SLRemovePronunciation', 'DISPID_SAFType',
    ...
    'DISPID_SpeechObjectTokens', 'SPEI_RESERVED6', 'SRTReSent',
    'eLEXTYPE_PRIVATE12', 'ISpeechLexiconWord', 'DISPID_SPPParent',
    'DISPID_SPAStartElementInResult', 'DISPID_SLPs_NewEnum',
    'SpeechVoiceEvents', 'SAFTCCITT_ALaw_44kHzStereo',
    '_SPAUDIOSTATE', 'DISPID_SRGDictationSetState',
    'SDA_Two_Trailing_Spaces', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRAudioInput', 'ISpPhoneticAlphabetSelection',
    'DISPID_SVSInputSentenceLength', 'SGLexical', 'SPEI_PHONEME',
    'DISPID_SABufferInfo', 'DISPID_SVResume', 'ISpLexicon',
    'SAFT16kHz8BitMono', 'SPPS_Function', 'ISpRecoCategory',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRGetRecognizers',
    'SPSModifier', 'DISPID_SPRules_NewEnum', 'SVP_3',
    'ISpeechDataKey', 'SRAExport', 'DISPID_SPACommit',
    'DISPID_SVEAudioLevel', 'DISPID_SAFGetWaveFormatEx',
    'eLEXTYPE_PRIVATE16', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRCEPropertyNumberChange', 'SpeechTokenIdUserLexicon',
    'SVSFParseSsml', 'DISPID_SRGSetWordSequenceData', 'SREBookmark',
    'SBONone', 'SPXRO_SML', 'SpeechCategoryAudioOut', 'DISPID_SOTId',
    'SAFTADPCM_22kHzMono', 'SSTTTextBuffer', 'DISPID_SRRPhraseInfo',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRIsUISupported',
    'DISPID_SVSLastBookmark', 'DISPID_SDKEnumKeys', 'DISPID_SRGId',
    'DISPID_SpeechLexicon', 'ISpNotifySink', 'ISpRecoGrammar',
    'SPFM_NUM_MODES', 'DISPID_SRCEHypothesis',
    'DISPID_SPIReplacements', 'SAFT32kHz8BitMono',
    'SRERecoOtherContext', 'DISPID_SRRRecoContext', 'DISPID_SGRName',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRRAlternates',
    'SpMMAudioEnum', 'DISPID_SGRsCount', 'SAFT32kHz16BitMono',
    'SPSVerb', 'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpRecoResult', 'SPCT_DICTATION', 'SAFT16kHz8BitStereo',
    'SSTTDictation', 'SPWF_INPUT', 'DISPID_SDKSetLongValue',
    'SVEViseme', 'SDTReplacement', 'SPCS_DISABLED', 'DISPID_SLPType',
    'SVSFIsFilename', 'SPFM_OPEN_READONLY', 'SRSInactiveWithPurge',
    'SPSNotOverriden', 'DISPID_SRCERecognizerStateChange',
    'SSFMOpenForRead', 'SpTextSelectionInformation',
    'tagSPPROPERTYINFO', 'SpeechCategoryAudioIn',
    'DISPID_SpeechPhraseReplacement', 'SpeechVoiceCategoryTTSRate',
    'IEnumString', 'SVF_Emphasis', 'DISPID_SRDisplayUI',
    'SPPHRASEREPLACEMENT', 'SVP_10', 'SRSInactive',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechFileStream',
    'STSF_FlagCreate', 'SDKLCurrentConfig',
    'DISPID_SVESentenceBoundary', 'SDA_No_Trailing_Space',
    'DISPID_SLWsCount', 'SVF_None', 'SpeechWordType',
    'DISPID_SpeechPhraseAlternates', 'SPINTERFERENCE_NOSIGNAL',
    'SPAR_Low', 'SpeechEmulationCompareFlags',
    'DISPID_SRCreateRecoContext',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT24kHz16BitStereo',
    'SRAImport', 'DISPID_SRCRetainedAudioFormat',
    'eLEXTYPE_RESERVED6', 'DISPID_SpeechPhraseRule',
    'SDA_Consume_Leading_Spaces', 'ISpObjectWithToken', 'SASRun',
    'SAFT44kHz8BitMono', 'ISpeechRecoResult2',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRProfile', 'SpShortcut',
    'DISPID_SRRecognizer', 'SPAUDIOSTATUS', 'DISPID_SOTCDefault',
    'SAFT24kHz8BitMono', 'SPGRAMMARWORDTYPE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRTLength',
    'SpPhoneConverter', 'SPDKL_LocalMachine', 'DISPID_SLPLangId',
    'SpeechCategoryPhoneConverters', 'DISPID_SPRuleParent',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCEAudioLevel',
    'DISPID_SABIMinNotification', 'ISpeechBaseStream',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechSpecialTransitionType',
    'SAFTADPCM_8kHzMono', 'STSF_LocalAppData', 'SPCS_ENABLED',
    'SpPhraseInfoBuilder', 'ISpRecoContext2', 'SPEI_SR_BOOKMARK',
    'SITooLoud', 'DISPID_SLAddPronunciation', 'SpeechRuleState',
    'SRAONone', 'SpeechAddRemoveWord', 'SPWT_LEXICAL', 'SAFTText',
    'SDKLLocalMachine', 'DISPID_SMSAMMHandle', 'DISPID_SRRTimes',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPEEngineConfidence',
    'SAFT8kHz8BitMono', 'ISpeechGrammarRules', 'UINT_PTR',
    'DISPID_SOTsCount', 'SECFIgnoreCase', 'SPEI_RESERVED2',
    'DISPID_SPAs_NewEnum', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SOTCreateInstance', 'DISPID_SLWWord',
    'eLEXTYPE_LETTERTOSOUND', 'SREPropertyNumChange',
    'SPEI_SR_PRIVATE', 'SpeechAudioFormatGUIDText',
    'DISPID_SPEAudioTimeOffset', 'IInternetSecurityMgrSite',
    'SRTEmulated', 'SPEI_TTS_AUDIO_LEVEL', 'SpeechAudioState',
    'DISPID_SGRSTRule', 'DISPID_SGRSTNextState', 'DISPID_SASState',
    'DISPID_SPEDisplayAttributes', 'SDKLCurrentUser',
    'SpeechCategoryVoices', 'DISPID_SRGSetTextSelection',
    'SAFT8kHz16BitStereo', 'SpeechAudioFormatType', 'SPPS_RESERVED1',
    'DISPID_SRGRules', 'SREStateChange', 'SPINTERFERENCE',
    'SpeechDiscardType', 'eLEXTYPE_PRIVATE20', 'SPRECOCONTEXTSTATUS',
    'SDTRule', 'DISPID_SGRsAdd', 'SpeechTokenShellFolder',
    'SP_VISEME_8', 'SpMemoryStream', 'SRSEDone', 'DISPID_SRIsShared',
    'SpeechAllElements', 'DISPID_SFSClose',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SPCIdToPhone',
    'DISPID_SRCState', 'SVPAlert', 'SpeechVoiceSpeakFlags',
    'DISPID_SPPFirstElement', 'DISPID_SGRsItem', 'DISPID_SLPsItem',
    'SPPS_RESERVED4', 'DISPID_SVSCurrentStreamNumber',
    'SAFT16kHz16BitMono', 'ISpDataKey', 'SECFDefault',
    'DISPID_SGRsCommit', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPEVENTSOURCEINFO', 'SPGS_DISABLED', 'SRESoundEnd',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_4', 'SPPHRASE',
    'SpeechTokenKeyAttributes', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRState', 'DISPID_SRGetPropertyNumber', 'STCInprocServer',
    'SpeechWordPronounceable', 'ISpeechVoice', 'SECLowConfidence',
    'SDA_One_Trailing_Space', 'SPTEXTSELECTIONINFO', 'SASPause',
    'DISPID_SpeechObjectTokenCategory', 'SPAO_RETAIN_AUDIO',
    'Speech_StreamPos_RealTime', 'DISPID_SPAPhraseInfo',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechRetainedAudioOptions',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPRuleEngineConfidence', 'SGSDisabled', 'SPAS_CLOSED',
    'DISPID_SRStatus', 'SpeechPropertyResourceUsage', 'SP_VISEME_11',
    'ISpeechObjectTokens', 'ISpeechXMLRecoResult',
    'SpObjectTokenCategory', 'SPEI_REQUEST_UI',
    'DISPID_SpeechVoiceEvent', 'SPEVENTENUM', 'SAFT11kHz8BitStereo',
    'SPEI_RESERVED1', 'ISpStream', 'SPCT_COMMAND',
    'DISPID_SPPEngineConfidence', 'DISPID_SPPs_NewEnum',
    'DISPID_SOTRemoveStorageFileName', 'SpeechEngineConfidence',
    'SPRS_ACTIVE', 'SRSEIsSpeaking', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRCResume',
    'SREInterference', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SABufferNotifySize',
    'eLEXTYPE_PRIVATE9', 'SVP_11', 'eLEXTYPE_RESERVED8', 'SSFMCreate',
    'DISPID_SMSALineId', 'SpeechFormatType', 'SVEWordBoundary',
    'SWTDeleted', 'SpeechPropertyNormalConfidenceThreshold',
    'ISpeechAudioFormat', 'SREFalseRecognition', 'ISpeechMMSysAudio',
    'SP_VISEME_5', 'DISPID_SRCEInterference', 'DISPID_SGRsFindRule',
    'SpeechLexiconType', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRGetPropertyString', 'SAFT8kHz8BitStereo', 'SINone',
    'DISPID_SPIGrammarId', 'ISequentialStream', 'SP_VISEME_19',
    'ISpVoice', 'DISPID_SPEPronunciation',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_VOICE_CHANGE',
    'ISpXMLRecoResult', 'DISPID_SVVolume', 'DISPID_SPRs_NewEnum',
    'DISPID_SRRAudioFormat', 'DISPID_SRCRequestedUIType',
    'SAFT24kHz16BitMono', 'SPFM_OPEN_READWRITE', 'SPCATEGORYTYPE',
    'DISPID_SWFEExtraData', 'DISPID_SVEStreamStart',
    'ISpPhoneticAlphabetConverter', 'SPRST_NUM_STATES',
    'DISPID_SVGetAudioInputs', 'SAFTADPCM_11kHzStereo',
    'DISPID_SPILanguageId', 'eLEXTYPE_PRIVATE14',
    'SPXMLRESULTOPTIONS', 'SPPS_RESERVED2', 'ISpStreamFormat',
    'SPWORDLIST', 'SAFT44kHz16BitMono', 'SVSFVoiceMask',
    'ISpEventSink', 'ISpeechLexiconWords', 'SVEBookmark',
    'DISPID_SLGenerationId', 'SAFT22kHz8BitMono',
    'DISPID_SPARecoResult', 'DISPID_SPEAudioSizeTime', 'SSTTWildcard',
    'SPPS_Noun', 'SVP_19', 'DISPID_SABIBufferSize',
    'DISPID_SpeechMemoryStream', 'SPAUDIOOPTIONS', 'SDTProperty',
    'DISPID_SRAudioInputStream', 'DISPID_SRRSaveToMemory',
    'SPFM_CREATE', 'SpeechDictationTopicSpelling', 'DISPID_SRRAudio',
    'DISPID_SGRsCommitAndSave', 'DISPID_SAEventHandle',
    'SREPropertyStringChange', 'SRAInterpreter',
    'DISPID_SPERetainedSizeBytes', 'SPPHRASEELEMENT',
    'SECHighConfidence', 'DISPID_SRCVoice', 'eLEXTYPE_RESERVED10',
    'SPEI_START_SR_STREAM', 'SPWAVEFORMATTYPE', 'ISpeechWaveFormatEx',
    'SRERecognition', 'SWTAdded', 'DISPID_SDKDeleteValue',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_ADAPTATION',
    'DISPID_SAFGuid', 'DISPID_SVAudioOutputStream',
    'ISpeechRecoContext', 'DISPID_SpeechGrammarRule',
    'SPPARTOFSPEECH', 'ISpeechObjectToken', 'DISPID_SPPChildren',
    'DISPID_SRCPause', 'SpSharedRecognizer',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFTGSM610_11kHzMono',
    'DISPID_SPRulesItem', 'DISPID_SpeechPhraseProperties', 'SVP_18',
    'SRCS_Disabled', 'SFTInput', 'ISpPhrase',
    'SAFTCCITT_ALaw_22kHzMono', 'SpNullPhoneConverter',
    'ISpeechAudio', 'SPPHRASERULE', 'DISPID_SGRSRule',
    'DISPID_SOTSetId', 'DISPID_SGRSTType',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVSpeak',
    'SSFMOpenReadWrite', 'eLEXTYPE_PRIVATE4', 'DISPID_SRGCommit',
    'ISpRecognizer3', 'SRAORetainAudio', 'SPPS_NotOverriden',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVEStreamEnd',
    'SpFileStream', 'DISPID_SLWType', 'STSF_CommonAppData', 'SVP_1',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPELexicalForm',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SLODynamic', 'tagSTATSTG',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechRecognizer',
    'SPLO_DYNAMIC', 'ISpeechPhraseAlternates', 'DISPID_SPPConfidence',
    'SGRSTTRule', 'SGSEnabled', 'SVSFParseAutodetect', 'SITooSlow',
    'SVP_16', 'SPCONTEXTSTATE', 'DISPID_SPEActualConfidence',
    'SP_VISEME_1', 'ISpAudio', 'eLEXTYPE_PRIVATE6',
    'SPSERIALIZEDRESULT', 'SpCustomStream', 'SpeechGrammarWordType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SRGRecoContext',
    'SAFT16kHz16BitStereo', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRSClsidEngine', 'SVSFNLPMask', 'eLEXTYPE_PRIVATE17',
    'SPEI_MAX_TTS', 'SPAR_Unknown', 'DISPID_SVEEnginePrivate',
    'SGLexicalNoSpecialChars', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTRemove', 'SPSHT_Unknown', 'DISPID_SRCRetainedAudio',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'Speech_StreamPos_Asap',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_12',
    'SPEI_HYPOTHESIS', 'SAFT22kHz8BitStereo', 'DISPID_SAVolume',
    'SAFTADPCM_11kHzMono', 'SVP_0', 'DISPID_SPPNumberOfElements',
    'DISPID_SVGetVoices', 'DISPID_SVAlertBoundary',
    'SpeechRecoContextState', 'SPSERIALIZEDPHRASE', 'SRSActive',
    'DISPID_SpeechPhraseInfo', 'SPRST_INACTIVE',
    'DISPID_SASNonBlockingIO', 'DISPID_SRGCmdSetRuleIdState',
    'SpStreamFormatConverter', 'SRARoot',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPRsItem',
    'ISpeechPhraseProperty', 'SPEI_RECOGNITION',
    'DISPID_SPIRetainedSizeBytes', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRCESoundEnd', 'DISPID_SRGReset',
    'Speech_Max_Word_Length', 'SPEI_MAX_SR',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPIEngineId',
    'SPAR_Medium', 'SPEI_PROPERTY_NUM_CHANGE', 'SPSHORTCUTPAIR',
    'SPWORDTYPE', 'STSF_AppData', 'SpResourceManager',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRCSetAdaptationData',
    'SpLexicon', 'SpNotifyTranslator', 'SVEPrivate',
    'DISPID_SLWs_NewEnum', 'ISpRecognizer', 'SpUnCompressedLexicon',
    'ISpeechRecoResultDispatch', 'DISPID_SGRSTPropertyId',
    'SPEI_SOUND_START', 'SPRULE', 'ISpeechPhraseElements',
    'SpeechPropertyResponseSpeed', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SpeechLexiconWords', 'SVF_Stressed',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SVPause',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechPhraseElements',
    'eWORDTYPE_DELETED', 'SDTAll', '_RemotableHandle',
    'SpeechVisemeFeature', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SGRSTsItem', 'DISPID_SOTDisplayUI',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechGrammarRules', 'SDTLexicalForm', 'SGRSTTTextBuffer',
    'DISPID_SASetState', 'SpAudioFormat',
    'DISPID_SPIEnginePrivateData', 'SBOPause', 'DISPID_SPEsCount',
    ...
    'DISPID_SpeechMMSysAudio', 'DISPID_SPPsItem',
    'DISPID_SPRNumberOfElements', 'SpeechDisplayAttributes',
    'DISPID_SPANumberOfElementsInResult', 'SpeechCategoryRecognizers',
    'SpeechVoiceSkipTypeSentence', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPIGetText', 'SVP_6', 'SPSHT_OTHER', 'SGRSTTWildcard',
    'DISPID_SpeechRecognizerStatus', 'SAFT48kHz16BitMono',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SVGetAudioOutputs',
    'ISpeechAudioStatus', 'eLEXTYPE_PRIVATE5', 'SFTSREngine',
    'SGPronounciation', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SLGetWords', 'DISPID_SPRuleName',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SDKGetStringValue',
    'SpeechRecognizerState', 'DISPID_SPIElements',
    'SPBOOKMARKOPTIONS', 'SVSFUnusedFlags',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPEsItem',
    'SpeechStreamFileMode', 'SpStream', 'SREAudioLevel', 'SVEPhoneme',
    'SpObjectToken', 'SPRS_ACTIVE_USER_DELIMITED',
    'SWPKnownWordPronounceable', 'SpInprocRecognizer',
    'SPAUDIOBUFFERINFO', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVEStartInputStream', 'DISPID_SRRSetTextFeedback',
    'SREAllEvents', 'DISPID_SGRAddState', 'DISPID_SPRsCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_13',
    'SP_VISEME_14', 'SPEI_MIN_TTS', 'SVP_15', 'SPPS_Modifier',
    'Speech_Default_Weight', 'SPINTERFERENCE_NOISE',
    'DISPID_SVSLastResult', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTADPCM_44kHzStereo', 'SP_VISEME_0', 'ISpeechRecognizer',
    'SpMMAudioOut', 'SPVPRI_NORMAL', 'STCInprocHandler',
    'SpeechGrammarRuleStateTransitionType', 'ISpResourceManager',
    'ISpeechPhraseAlternate', 'DISPID_SVEPhoneme',
    'ISpGrammarBuilder', 'DISPID_SpeechPhraseAlternate',
    'SpSharedRecoContext', 'DISPID_SLPsCount', 'DISPID_SRCBookmark',
    ...
    'SAFT44kHz16BitStereo', 'DISPID_SPAsCount', 'SP_VISEME_15',
    'SPVPRI_OVER', 'DISPID_SVSInputWordLength', 'DISPID_SLPPhoneIds',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRCERecognition',
    'DISPID_SWFEFormatTag', 'DISPID_SABIEventBias',
    'DISPID_SGRAddResource', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCEEnginePrivate', 'STCAll', 'DISPID_SBSRead',
    'SpeechMicTraining', 'DISPID_SREmulateRecognition',
    'SREHypothesis', 'SpeechAudioProperties', 'SAFT32kHz8BitStereo',
    'DISPID_SPCPhoneToId', 'SPADAPTATIONRELEVANCE',
    'SpCompressedLexicon', 'DISPID_SPEDisplayText', 'SVEVoiceChange',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRunState', 'SITooFast',
    'SpeechUserTraining', 'ISpeechCustomStream', 'ISpSerializeState',
    'SVP_20', 'SASClosed', 'SpeechTokenValueCLSID',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SDKSetStringValue',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_RESERVED5',
    'SAFT24kHz8BitStereo', 'DISPID_SOTCId',
    'DISPID_SRGIsPronounceable', 'SRADynamic', 'SAFT48kHz16BitStereo',
    'SpeechRecoEvents', 'SpeechPartOfSpeech', 'DISPID_SVStatus',
    'ISpeechPhraseReplacement', 'SPAS_STOP', 'IStream',
    'DISPID_SWFEChannels', 'ISpeechPhraseRules', 'DISPID_SGRSTsCount',
    'SAFT12kHz8BitMono', 'DISPID_SRGetFormat', 'SpeechGrammarState',
    'SECFNoSpecialChars', 'SPSSuppressWord', 'SPBO_AHEAD',
    'SVEEndInputStream', 'DISPID_SGRId', 'DISPID_SpeechRecoResult',
    'eLEXTYPE_PRIVATE18', 'SPDKL_DefaultLocation',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE11',
    'DISPID_SOTCategory', 'DISPID_SpeechPhraseReplacements',
    'LONG_PTR', 'SPLO_STATIC', 'IInternetSecurityManager',
    'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechXMLRecoResult', 'ISpeechRecognizerStatus',
    'SAFTNonStandardFormat', 'DISPID_SGRSTText',
    'DISPID_SLGetGenerationChange', 'SSSPTRelativeToStart',
    'DISPID_SLGetPronunciations', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechRecoContext', 'SREStreamEnd', 'DISPID_SLWLangId',
    'SPINTERFERENCE_NONE', 'DISPID_SAStatus', 'SRSActiveAlways',
    'SP_VISEME_17', 'SVSFDefault', 'DISPID_SRGCmdLoadFromMemory',
    'SPEI_SOUND_END', 'ISpPhoneConverter', 'SVP_5', 'SPPS_Unknown',
    'SPGRAMMARSTATE', 'DISPID_SPISaveToMemory',
    'SpeechCategoryAppLexicons', 'SPEI_START_INPUT_STREAM',
    'SpInProcRecoContext', 'SVEAudioLevel', 'SVP_8', 'SGRSTTEpsilon',
    'SPSTREAMFORMATTYPE', 'DISPID_SVEventInterests',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRRTStreamTime',
    'eLEXTYPE_VENDORLEXICON', 'SPEI_PHRASE_START',
    'DISPID_SVSRunningState', 'SRERequestUI', 'SpeechTokenKeyFiles',
    'SpVoice', 'DISPID_SGRClear', 'DISPID_SpeechAudioFormat',
    'SP_VISEME_21', 'SP_VISEME_18', 'SRTSMLTimeout',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRCEventInterests', 'eLEXTYPE_PRIVATE19', 'SP_VISEME_2',
    'DISPID_SGRSAddWordTransition', 'SAFT12kHz16BitMono',
    'DISPID_SpeechRecoResult2', 'DISPID_SRSAudioStatus',
    'SPSFunction', 'DISPID_SPRuleConfidence', 'SGRSTTDictation',
    'SpWaveFormatEx', 'DISPID_SRCCmdMaxAlternates',
    'SPRECORESULTTIMES', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRGCmdLoadFromResource', 'SAFT11kHz16BitStereo',
    'DISPID_SPPName', 'SpeechDataKeyLocation', 'SPVPRI_ALERT',
    'SpMMAudioIn', 'SAFT8kHz16BitMono', 'SAFTDefault',
    'DISPID_SVEVoiceChange', 'SRCS_Enabled', 'SPPS_LMA',
    'SSFMCreateForWrite', 'DISPID_SPIStartTime', 'SPDKL_CurrentUser',
    'DISPID_SOTDataKey', 'SPRS_INACTIVE', 'SPAR_High',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SBSWrite', 'DISPID_SPRText', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_APP', 'SGDSActiveUserDelimited',
    'SWPUnknownWordPronounceable', 'SPDKL_CurrentConfig',
    'SAFT44kHz8BitStereo', 'SPPS_Verb', 'SpeechAudioVolume',
    'SPPS_RESERVED3', 'DISPID_SRCESoundStart', 'eLEXTYPE_PRIVATE13',
    'SLOStatic', 'SRESoundStart', 'ISpeechPhraseElement',
    'SpeechRecognitionType', 'DISPID_SVVoice', 'DISPID_SBSSeek',
    'ISpeechObjectTokenCategory', 'DISPID_SPERequiredConfidence',
    'DISPID_SDKSetBinaryValue', 'ISpeechLexiconPronunciations',
    'DISPID_SGRSTs_NewEnum', 'SAFTADPCM_8kHzStereo',
    'eLEXTYPE_RESERVED9', 'SpeechLoadOption', 'ISpShortcut',
    'ISpeechLexicon', 'DISPID_SPPsCount', 'SPAUDIOSTATE',
    'SVSFIsNotXML', 'ISpeechGrammarRuleStateTransitions',
    'SPCT_SLEEP', 'SpPhoneticAlphabetConverter',
    'DISPID_SPRulesCount', 'ISpeechPhraseInfoBuilder', 'SPVISEMES',
    'SREAdaptation', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SpeechAudioStatus', 'DISPID_SPEAudioSizeBytes',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPINTERFERENCE_TOOQUIET',
    'SP_VISEME_12', 'DISPID_SRSNumberOfActiveRules',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLWPronunciations',
    'SGDisplay', 'SPEI_TTS_BOOKMARK', 'SGDSInactive',
    'SAFT11kHz16BitMono', 'STCRemoteServer', 'SPFILEMODE',
    'SPPS_Noncontent', 'SPSHT_EMAIL', 'DISPID_SPRuleId',
    'SPSHORTCUTPAIRLIST', 'SPSMF_SRGS_SAPIPROPERTIES', 'SP_VISEME_16',
    'DISPID_SRCEAdaptation', 'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPRG',
    'SpeechStreamSeekPositionType', 'eLEXTYPE_RESERVED4',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechFileStream',
    'DISPID_SMSADeviceId', 'SP_VISEME_6',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTCSetId',
    'ISpMMSysAudio', 'SAFTExtendedAudioFormat', 'SPSEMANTICFORMAT',
    'DISPID_SpeechAudio', 'SPBO_PAUSE',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_MIN_SR',
    'DISPID_SPIProperties', 'ISpRecognizer2', 'ISpeechPhraseRule',
    'SVP_9', 'DISPID_SWFEBitsPerSample', 'DISPID_SPIAudioSizeTime',
    'SVSFIsXML', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SOTCGetDataKey',
    'DISPID_SDKGetBinaryValue', 'ISpRecoGrammar2',
    'ISpeechPhraseReplacements', 'DISPID_SPCLangId', 'SPGS_ENABLED',
    'DISPID_SpeechAudioBufferInfo', 'SPCT_SUB_DICTATION',
    'SP_VISEME_7', 'SPEI_TTS_PRIVATE', 'SPRECOGNIZERSTATUS',
    'SREStreamStart', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRRSpeakAudio', 'SPSMF_UPS', 'DISPID_SPPValue',
    'DISPID_SAFSetWaveFormatEx', 'SAFTNoAssignedFormat',
    'DISPID_SpeechPhraseRules', 'SPSNoun', 'DISPID_SGRsDynamic',
    'SGDSActive', 'SVSFNLPSpeakPunc', 'DISPID_SpeechObjectToken',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVPriority',
    'DISPID_SMSGetData', 'DISPID_SVGetProfiles', 'DISPID_SMSSetData',
    'DISPID_SVSPhonemeId', 'DISPID_SWFESamplesPerSec',
    'ISpeechPhraseInfo', 'DISPID_SVRate', 'SDKLDefaultLocation',
    'SAFT11kHz8BitMono', 'SINoise', 'SVPNormal', 'ISpeechVoiceStatus',
    'SVPOver', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SFSOpen', '_ISpeechVoiceEvents', 'DISPID_SVIsUISupported',
    'SPRST_ACTIVE', 'SECFEmulateResult', 'SPFM_CREATE_ALWAYS',
    'SVP_4', 'DISPID_SPIRule', 'SDTPronunciation', 'DISPID_SOTsItem',
    'DISPID_SpeechDataKey', 'SpeechVisemeType', 'SPBINARYGRAMMAR',
    'SDTAlternates', 'ISpeechLexiconPronunciation', 'SPSUnknown',
    'SVESentenceBoundary', 'SPEI_SR_RETAINEDAUDIO',
    'SPEI_RECO_STATE_CHANGE', 'SPLEXICONTYPE', 'SECNormalConfidence',
    'DISPID_SpeechVoice', 'SECFIgnoreWidth',
    'SpeechGrammarTagWildcard', 'SGSExclusive', 'ISpNotifySource'
]
